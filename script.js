document.addEventListener('DOMContentLoaded', function () {
  ...
  const navbar = document.querySelector('nav, .navbar, [class*="navbar"]');
  ...
  if (contactForm) {
    function getFieldError(field) {
      ...
      if (value !== '') {
        ...
        if ((type === 'text' || field.tagName.toLowerCase() === 'textarea') && name.includes('name')) {
          if (value.length < 2) {
            return 'Name must be at least 2 characters.';
          }
        }

        if (field.tagName.toLowerCase() === 'textarea' && field.hasAttribute('minlength')) {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '2c1f7ab1-bb14-435f-a159-1372f8f7b95f',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '2c1f7ab1-bb14-435f-a159-1372f8f7b95f';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '2c1f7ab1-bb14-435f-a159-1372f8f7b95f';
